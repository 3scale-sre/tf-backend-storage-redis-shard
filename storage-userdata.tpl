...
write_files:
    ...
    - path: /var/spool/cron/root
      ...
      content: |
        ...
        */5 * * * * docker run --user=root --name=redis-slowlogs --rm -e REDIS_HOST=localhost -e ELASTICSEARCH_HOST=${ELASTICSEARCH_HOST} -e ELASTICSEARCH_INDEX=${ELASTICSEARCH_INDEX} --network=host quay.io/3scale/redis-slowlog-es:v0.0.2 >> /var/log/crons/slowlogs 2>&1
